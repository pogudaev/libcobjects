...
static int co_string_is_valid(const co_string *string)
{
	...
	if (string->length + 1 > string->alloc_length) {
		return FAIL;
	}

	if (string->alloc_length == 0) {
		return FAIL;
	}

	if (string->c_str[string->length] != '\0') {
		return FAIL;
	}

	if (strlen(string->c_str) != string->length) {
		return FAIL;
	}
...
{
	if (co_string_is_valid(string) != OK) {
		return FAIL;
	}
...
static int co_string_is_eq_value(const co_string *string, const char *cstring)
{
	...
	if (strcmp(string->c_str, cstring) != 0) {
		return FAIL;
	}

	if (string->c_str == cstring) {
		return FAIL;
	}
...
static int test_co_string_create_0()
{
	...
	if (co_string_is_default(string) != OK) {
		return FAIL;
	}
...
static int test_co_string_create_from_c_str_0()
{
	...
	if (co_string_is_eq_value(string, test_value) != OK) {
		return FAIL;
	}
...
static int test_co_string_clone_0()
{
	...
	if (co_string_is_eq_value(string1, test_value) != OK) {
		return FAIL;
	}

	if (co_string_is_eq_value(string2, test_value) != OK) {
		return FAIL;
	}
	...
	if (string1->c_str == string2->c_str) {
		return FAIL;
	}
...
static int test_co_string_copy_0()
{
	...
	if (co_string_copy(string2, string1) != CO_OK) {
		return FAIL;
	}
...
static int test_co_string_copy_4()
{
	...
	if (co_string_copy(string, NULL) == CO_OK) {
		return FAIL;
	}
...
static int test_co_string_copy_5()
{
	...
	if (co_string_copy(NULL, string) == CO_OK) {
		return FAIL;
	}
...
static int test_co_string_reset_0()
{
	...
	if (co_string_reset(string) != CO_OK) {
		return FAIL;
	}
...
static int test_co_string_set_0()
{
	...
	if (co_string_set(string, test_value2) != CO_OK) {
		return FAIL;
	}

	if (co_string_is_eq_value(string, test_value2) != OK) {
		return FAIL;
	}
...
static int test_co_string_set_2()
{
	...
	if (co_string_set(string, NULL) == CO_OK) {
		return FAIL;
	}

	if (co_string_is_eq_value(string, test_value1) != OK) {
		return FAIL;
	}
...
static int test_co_string_set_3()
{
	...
	if (co_string_set(NULL, test_value1) == CO_OK) {
		return FAIL;
	}
...
static int test_co_string_add_0()
{
	...
	if (co_string_add(string, test_value2) != CO_OK) {
		return FAIL;
	}

	if (co_string_is_eq_value(string, test_value3) != OK) {
		return FAIL;
	}
...
static int test_co_string_add_3()
{
	...
	if (co_string_add(string, NULL) == CO_OK) {
		return FAIL;
	}
...
static int test_co_string_add_4()
{
	...
	if (co_string_add(NULL, test_value1) == CO_OK) {
		return FAIL;
	}
